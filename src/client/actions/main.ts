...
enum ActionTypes {
  ...
  SELECTSHIFTYEAR = '[count] selectshiftyear',
  SELECTSHIFTMONTH = '[count] selectshiftmonth',
  SELECTSHIFTAREA = '[dayline] selectshiftarea',
  SHIFTPAGINATION = '[dayline] shiftpagination',
  SELECTYEAR = '[count] selectyear',
  SELECTMONTH = '[count] selectmonth',
